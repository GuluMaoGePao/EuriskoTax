...
#       把同一套 100 项 e2e 门禁再跑一遍，把「本地绿、上线炸」的迁移/字段类问题拦在本地。
#
# 用法：
...
Write-Host "  流程: 起演练库 -> generate -> migrate deploy -> 100 项 e2e" -ForegroundColor Cyan
Write-Host "=============================================" -ForegroundColor Cyan
...
# ---- 3. 跑完整门禁 ----
Write-Step "3/4 运行 100 项 e2e 门禁（PostgreSQL 演练库）"
& node $VerifyScript
