...
(function () {
    ...
    var CATEGORIES = {
        ...
        stamp: '印花税',
        social: '社保公积金',
        // 不是税，是跟着用工走的规费（残保金 / 工会经费）—— 与社保同源但口径不同
        fee: '用工规费（残保金 / 工会经费）'
    };
    ...
    var TAXES = [
        ...
        {
            id: 'health-insurance',
            name: '税优健康险（商业健康保险 2400 元/年税前扣除）',
            category: 'iit',
            scope: '个人购买符合规定的商业健康保险产品（带税优识别码）的支出，按 2400 元/年（200 元/月）限额在计算应纳税所得额时税前扣除；单位统一购买的视同个人购买',
            effectiveFrom: '2017-07-01',
            expiresOn: null,
            basis: [
                { title: '《关于将商业健康保险个人所得税试点政策推广到全国范围实施的通知》', doc: '财税〔2017〕39 号' },
                { title: '《中华人民共和国个人所得税法》第四条（保险赔款免征个人所得税）', doc: '个人所得税法（2018 年修正）' }
            ],
            params: { rules: 'healthInsuranceRules', rates: 'comprehensiveTaxRates' },
            page: '/seo/health-insurance.html',
            note: '与个人养老金同一条纠偏：**扣的也是应纳税所得额**，少交的税 = T(x) − T(x − min(年保费, 2400))。最大差别在**领取环节**：税优健康险的保险赔款免征个人所得税，**没有领取税** —— 节税是确定的（2400 × 适用税率），但节税额很小（最高 1080 元/年），**不足以成为购买一款保险产品的理由**，必须结合保障与产品本身评估。'
        },
        {
            id: 'donation',
            name: '公益慈善事业捐赠扣除（应纳税所得额 30% 限额，可在综合 / 经营 / 分类所得中扣除）',
            category: 'iit',
            scope: '个人通过境内公益性社会组织、县级以上人民政府及其部门等国家机关向教育、扶贫、济困等公益慈善事业的捐赠支出：可在分类所得、综合所得或者经营所得中扣除，扣除限额为各所得项目应纳税所得额的 30%',
            effectiveFrom: '2019-01-01',
            expiresOn: null,
            basis: [
                { title: '《关于公益慈善事业捐赠个人所得税政策的公告》', doc: '财政部 税务总局公告 2019 年第 99 号' },
                { title: '《中华人民共和国个人所得税法》第六条第三款（公益捐赠扣除）', doc: '主席令第九号（2018 年修正）' }
            ],
            params: { rules: 'donationRules', rates: 'comprehensiveTaxRates' },
            note: '限额是**应纳税所得额**的 30%，不是收入的 30%；综合 / 经营所得按**当年**、分类所得按**当月**。捐赠额本身也不是想捐多少就扣多少：股权、房产按**财产原值**，其他非货币性资产按市场价格。一个所得项目扣不完的**可以在其他项目继续扣**，**扣除顺序自行决定**且影响税额（同一笔捐赠先扣经营还是先扣综合，实测差 3756 元）；但**已在分类所得中扣除的不再调整到其他所得**，超出全部限额的部分个人**不结转以后年度**（企业可结转 3 年）。核定征收的经营所得不扣捐赠。追补扣除与补充票据均为 **90 日**，票据留存 **5 年**。'
        },
        {
            // 17D-12（v1.68.0）：个人转让房屋 —— 与 donation 同款，20 个速算器里没有一个能收它
            id: 'property-transfer',
            name: '个人转让房屋（财产转让所得 20%：查账 / 核定、满五唯一免征、换购住房退税）',
            category: 'iit',
            scope: '个人转让自有房屋（住房 / 非住房）取得的所得：以转让收入减除房屋原值、转让过程中缴纳的税金和合理费用后的余额为应纳税所得额，适用 20% 比例税率',
            effectiveFrom: '2019-01-01',   // 现行《个人所得税法》全面施行日（20% 比例税率自 1994 年个税法即已确立）
            expiresOn: null,
            basis: [
                { title: '《关于个人住房转让所得征收个人所得税有关问题的通知》', doc: '国税发〔2006〕108 号' },
                { title: '《关于个人转让房屋有关税收征管问题的通知》', doc: '国税发〔2007〕33 号' },
                { title: '《关于个人出售住房所得征收个人所得税有关问题的通知》', doc: '财税字〔1999〕278 号' },
                { title: '《关于个人无偿受赠房屋有关个人所得税问题的通知》', doc: '财税〔2009〕78 号' },
                { title: '《关于延续实施支持居民换购住房有关个人所得税政策的公告》', doc: '财政部 税务总局 住房城乡建设部公告 2026 年第 3 号' }
            ],
            params: { rules: 'propertyTransferRules' },
            note: '应纳税所得额是 **转让收入 − 房屋原值 − 转让环节税金 − 合理费用**，不是「售价」也不是「差价」的俗称：装修费有原值比例上限（商品房 10%、公有住房 / 经济适用房 15%），贷款利息与手续费公证费按实际扣除。**核定 1%~3% 不是可选项** —— 只有原值凭证不全时才核定，有凭证的必须查账（同一套房实测差 28.6 万）。**满五唯一**免征的「唯一」是**同一省 / 自治区 / 直辖市范围内**夫妻唯一一套（不是全国唯一、也不是同城唯一），自用年限按产权证与契税完税凭证**孰先**起算。受赠 / 继承的房屋再转让，原值是**原捐赠人 / 被继承人**的实际购置成本，不是 0。换购退税（2026 年第 3 号，至 **2027-12-31**）退的是**已缴**个税，按新购 ÷ 转让金额的比例退。'
        },
        {
            // 17D-13（v1.69.0）：非居民个人 / 无住所个人 —— 第三类「20 个速算器里没有一个能收它」
            id: 'non-resident',
            name: '非居民个人 / 无住所个人（90 天 · 183 天 · 满六年：哪些钱不用缴，能缴的按月换算税率表）',
            category: 'iit',
            scope: '在中国境内无住所的个人：一个纳税年度内累计居住是否满 183 天决定居民 / 非居民身份；在此之前要先按所得来源地过一道乘法（境内支付占比、境内工作天数占比）算出「收入额」，非居民按月换算后的综合所得税率表单独计税，数月奖金单独按 6 个月分摊且不减除费用',
            effectiveFrom: '2019-01-01',
            expiresOn: null,
            basis: [
                { title: '《中华人民共和国个人所得税法》第一条（居民 / 非居民）', doc: '主席令第九号（2018 年修正）' },
                { title: '《中华人民共和国个人所得税法实施条例》第四条', doc: '国务院令第 707 号' },
                { title: '《关于在中国境内无住所的个人居住时间判定标准的公告》', doc: '财政部 税务总局公告 2019 年第 34 号' },
                { title: '《关于非居民个人和无住所居民个人有关个人所得税政策的公告》', doc: '财政部 税务总局公告 2019 年第 35 号' }
            ],
            params: { rules: 'nonResidentRules', rates: 'bonusMonthlyTaxRates' },
            note: '进门第一个问题不是「扣多少」，是「**这笔钱要不要在中国缴**」：累计居住 ≤ 90 天只对境内工作期间**且**由境内雇主支付或者负担的部分计税（公式一）；90 天以上不满 183 天，境内工作期间的**不论谁支付**都要缴（公式二）；满 183 天成为居民但连续不满六年，境外所得中由境外单位或者个人支付的免税（公式三）；连续满六年且无单次离境超过 **30 天**的，境内境外**全部**所得都要缴 —— 六年判定只看**单次**离境是否超过 30 天，不再有「累计离境 90 天作废」那条老规则（财税字〔1995〕98 号已废止）。非居民按月换算后的综合所得税率表**逐月单独计税**（当月收入额 − 5000 → 月度税率表），不按年累计、**不享受**专项附加扣除、**不办**年度汇算；数月奖金单独按 **6 个月**分摊、**不减除费用**，一个年度内每人**只能用一次**。高管（董事、监事、高层管理职务）另有一套：无论是否在境内履行职务，由境内居民企业支付或者负担的报酬一律属境内所得。'
        },
        {
            id: 'enterprise-annuity',
            name: '企业年金 / 职业年金（ETE 递延纳税：缴费扣除 + 领取全额单独计税）',
            category: 'iit',
            scope: '建立企业年金计划（或职业年金）的单位的职工：单位缴费 ≤ 工资总额 8% 计入个人账户时个人暂不纳税；个人缴费 ≤ 计税基数 4% 部分当期从应纳税所得额中扣除；投资收益暂不征税；领取时不并入综合所得、全额单独计税',
            effectiveFrom: '2014-01-01',
            expiresOn: null,
            basis: [
                { title: '《关于企业年金 职业年金个人所得税有关问题的通知》', doc: '财税〔2013〕103 号' },
                { title: '《企业年金办法》（人社部令第 36 号）', doc: '人力资源和社会保障部令第 36 号' }
            ],
            params: { rules: 'annuityRules', rates: 'comprehensiveTaxRates' },
            page: '/seo/enterprise-annuity.html',
            note: '三处最容易踩的口径：① 个人缴费免税上限是**计税基数 × 4%**，计税基数按本人上年度月平均工资且**当地社平工资 300% 封顶**，超 4% 的部分照常从税后工资扣；② 领取环节按领取额**全额**（本金 + 单位缴费 + 收益）单独计税、不并入综合所得 —— 按月领取用月度税率表，按年领取用综合所得税率表；③ 缴费环节少交的税 = T(x) − T(x − 年扣除额)，不是「缴费额 × 税率」的简单乘法。'
        },
        {
            id: 'expat-allowance',
        ...
        },
        {
            ...
            name: '残疾人就业保障金（残保金）',
            category: 'fee',
            scope: '用人单位安排残疾人就业未达到所在地规定比例的，按**差额人数**与本单位在职职工年平均工资之积计算缴纳；按年申报、一般随社保或税务渠道征收',
            effectiveFrom: '2015-10-01',
            expiresOn: null,
            basis: [
                { title: '《残疾人就业保障金征收使用管理办法》（第八条：应缴费额 = 差额人数 × 在职职工年平均工资）', doc: '财税〔2015〕72 号' },
                { title: '《残疾人就业条例》（用人单位安排残疾人就业的比例不得低于本单位在职职工总数的 1.5%）', doc: '国务院令第 488 号' },
                { title: '《关于完善残疾人就业保障金制度 更好促进残疾人就业的总体方案》（年平均工资计征上限由社平 3 倍降为 **2 倍**，2020-01-01 起执行）', doc: '发改价格规〔2019〕2015 号' }
            ],
            params: { rules: 'disabilityFundRules' },
            page: '/seo/disability-fund.html',
            note: '残保金**不是**「工资总额 × 比例」，而是**差额人数 × 年平均工资** —— 招 1 名残疾人省下的是「一个人的年平均工资」，不是省 1.5% 的工资总额。年平均工资 = 上年工资总额 ÷ 在职职工人数，超过当地社平工资 **2 倍**的按 2 倍封顶（注意：社保缴费基数的封顶是 **300%**，两个数不是一回事）。'
        },
        {
            id: 'disability-fund-preferential',
            name: '残保金分档减缴与 30 人（含）以下暂免',
            category: 'fee',
            scope: '安排比例 1%（含）以上但未达规定比例的按应缴费额 50% 征收、1% 以下的按 90% 征收；在职职工人数 30 人（含）以下的企业暂免征收残保金，执行至 2027-12-31',
            effectiveFrom: '2023-01-01',
            expiresOn: '2027-12-31',
            basis: [
                { title: '《关于延续实施残疾人就业保障金优惠政策的公告》（分档减缴与 30 人以下暂免延续至 2027-12-31）', doc: '财政部 税务总局 中国残联公告 2023 年第 8 号' },
                { title: '《关于调整残疾人就业保障金征收政策的公告》（在职职工人数 30 人（含）以下企业暂免征收）', doc: '财政部公告 2019 年第 98 号' }
            ],
            params: { rules: 'disabilityFundRules' },
            page: '/seo/disability-fund.html',
            note: '**30 人是临界点**：30 人免征，31 人就要按全部 31 人算（不是只对超出的那 1 个人算），多招一个人的当年可能多出一笔远大于工资本身的残保金。分档减缴按**实际安排比例**三档：≥规定比例不缴、1%（含）以上按 50%、1% 以下按 90% —— 所以**先安排第一个残疾人的减缴效果远高于后续，边际递减**。'
        },
        {
            id: 'union-fee',
            name: '工会经费（未建会时为建会筹备金）',
            category: 'fee',
            scope: '建立工会组织的企业、事业单位按**全部职工工资总额的 2%** 向工会拨缴经费（40% 上缴上级工会、60% 基层留存）；未建立工会的由上级工会按工资总额 2% 收取建会筹备金',
            effectiveFrom: '2022-01-01',
            expiresOn: null,
            basis: [
                { title: '《中华人民共和国工会法》（第四十三条：按全部职工工资总额的 2% 向工会拨缴经费）', doc: '主席令第 107 号（2021 年修正）' },
                { title: '《中华人民共和国企业所得税法实施条例》（第四十一条：拨缴的工会经费不超过工资薪金总额 2% 的部分准予扣除）', doc: '国务院令第 512 号' },
                { title: '《关于工资总额组成的规定》（工会经费计费口径：含奖金、津贴补贴、加班加点工资）', doc: '国家统计局令第 1 号' }
            ],
            params: { rules: 'unionFeeRules' },
            page: '/seo/disability-fund.html',
            note: '基数是**工资总额**而不是社保缴费基数 —— 社保有 60% 保底与 300% 封顶，工资总额没有上限，所以高薪员工的工会经费远高于「按社保基数估」的数。企税前扣除限额同为工资薪金总额 2%（需凭《工会经费收入专用收据》或税务机关代收凭据），按规定拨缴的 2% 可全额扣除，超提部分不得扣除。'
        }
    ];
