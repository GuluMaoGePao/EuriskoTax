...
| [development/stage17-full-tax-coverage-plan.md](development/stage17-full-tax-coverage-plan.md) | **阶段17 全税种完整测算方案（核心卖点兑现）** —— UI 排版前置 → 17A spec 扩展 / 17B 反向迁移已有 4 个 deep / **17D 个税纵深补齐（P0）** / 17C 铺齐 5 类税种；目标覆盖 6/6 类 + 个税场景完整度 10/16（现状 6/6、**12/16**） | 2026-09-19 |
